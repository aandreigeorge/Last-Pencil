...
public class Main {
    ...
    public static void playGame() {
        ...
        while(pencilsOnTable > 0) {
            if(humansTurn) {
                ...
                pencilsOnTable = subtractPencilsAndCheckWinner(pencilsOnTable, playerName, humansTurn);
            } else {
                System.out.println(botName + "'s turn");
                pencilsOnTable = subtractPencilsAndCheckWinner(pencilsOnTable, botName, humansTurn);
            }
    ...
    public static int subtractPencilsAndCheckWinner (int pencilsOnTable, String name, boolean isHuman) {
        int pencilsTaken;
        ...
        if(isHuman) {
            ...
            try{
                ...
                if(pencilsTaken < 1 || pencilsTaken > 3) {
                    ...
                    return subtractPencilsAndCheckWinner(pencilsOnTable, name, true);
        ...
        if(pencilsOnTable  == 0) {
            System.out.println((name.equalsIgnoreCase("John") ? "Jack" : "John") + " won!");
            return 0;
        }
        return pencilsOnTable;
    }
